...
import { createTenant, isSubdomainAvailable, slugify } from "@/lib/tenant-store"
...
function SubdomainField({
  ...
  const check = useCallback((slug: string) => {
    ...
    timerRef.current = setTimeout(() => {
      setStatus(isSubdomainAvailable(slug) ? "available" : "taken")
    }, 400)
  }, [])
...
export function OnboardingForm() {
  ...
  const isStep1Valid =
    ...
    isSubdomainAvailable(business.subdomain)
  ...
  async function handleSubmit() {
    ...
    createTenant({
      ...
      businessType: business.businessType as "restaurant",
