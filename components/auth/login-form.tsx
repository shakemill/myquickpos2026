...
export function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (result?.error) {
        setError("Invalid email or password. Use tenant1 credentials: admin@tenant1.com / admin123")
        setIsLoading(false)
        return
      }
    ...
    <div className="flex min-h-screen w-full flex-col items-center justify-center px-6 py-12 lg:px-8">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mb-6 rounded-lg border border-primary/30 bg-primary/5 px-4 py-3">
          <p className="text-sm font-semibold text-foreground mb-2">Demo Credentials (tenant1)</p>
          <div className="space-y-1 text-xs text-muted-foreground">
            <p><span className="font-medium text-foreground">Admin:</span> admin@tenant1.com / admin123</p>
            <p><span className="font-medium text-foreground">Manager:</span> manager@tenant1.com / manager123</p>
            <p><span className="font-medium text-foreground">Cashier:</span> cashier1@tenant1.com / cashier123</p>
          </div>
        </div>
